...
def load_injections(
    ...
    with h5py.File(filename, "r") as ff:
        ...
        output["metadata"]["analysis_time"] = data.attrs["analysis_time_s"] / YEAR
        output["metadata"]["total_generated"] = data.attrs["total_generated"]
        ...
        output["metadata"]["n_found"] = total_n_samples
